...
public class MusicElectronicModMenus {
	...
	public static final RegistryObject<MenuType<TrapNationMusicListPage5Menu>> TRAP_NATION_MUSIC_LIST_PAGE_5 = REGISTRY
			.register("trap_nation_music_list_page_5", () -> IForgeMenuType.create(TrapNationMusicListPage5Menu::new));
	public static final RegistryObject<MenuType<TrapNationCreditPage4Menu>> TRAP_NATION_CREDIT_PAGE_4 = REGISTRY.register("trap_nation_credit_page_4",
			() -> IForgeMenuType.create(TrapNationCreditPage4Menu::new));
}
