...
@Mod("music_electronic")
public class MusicElectronicMod {
	public static final Logger LOGGER = LogManager.getLogger(MusicElectronicMod.class);
	public static final String MODID = "music_electronic";
