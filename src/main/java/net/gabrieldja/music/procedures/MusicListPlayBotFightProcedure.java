...
public class MusicListPlayBotFightProcedure {
		...
		if (world instanceof Level _level) {
			if (!_level.isClientSide()) {
				_level.playSound(null, new BlockPos(x, y, z),
						ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("music_electronic:bot-fight_everen-maxwell")), SoundSource.MUSIC,
						2, 1);
			} else {
