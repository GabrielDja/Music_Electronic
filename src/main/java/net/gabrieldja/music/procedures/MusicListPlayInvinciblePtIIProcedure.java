...
public class MusicListPlayInvinciblePtIIProcedure {
		...
		if (world instanceof Level _level) {
			if (!_level.isClientSide()) {
				_level.playSound(null, new BlockPos(x, y, z),
						ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("music_electronic:invincible-pt-ii_sendi-hoxha_deaf-kev")),
