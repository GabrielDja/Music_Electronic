...
import net.gabrieldja.music.network.MusicListButtonMessage;
...
public class MusicListScreen extends AbstractContainerScreen<MusicListMenu> {
	private final static HashMap<String, Object> guistate = MusicListMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public MusicListScreen(MusicListMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("music_electronic:textures/screens/music_list.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, "1 / 7", 9, 177, -16777216);
	}
