...
import net.gabrieldja.music.network.TrapNationCreditButtonMessage;
...
public class TrapNationCreditScreen extends AbstractContainerScreen<TrapNationCreditMenu> {
	private final static HashMap<String, Object> guistate = TrapNationCreditMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public TrapNationCreditScreen(TrapNationCreditMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("music_electronic:textures/screens/trap_nation_credit.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, "1 / 3", 140, 153, -16777216);
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 257, this.topPos + 9, 30, 20, Component.literal("x"), e -> {
			if (true) {
				MusicElectronicMod.PACKET_HANDLER.sendToServer(new TrapNationCreditButtonMessage(1, x, y, z));
				TrapNationCreditButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		}));
