...
import net.gabrieldja.music.network.TrapNationMusicListPage4ButtonMessage;
...
public class TrapNationMusicListPage4Screen extends AbstractContainerScreen<TrapNationMusicListPage4Menu> {
	private final static HashMap<String, Object> guistate = TrapNationMusicListPage4Menu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public TrapNationMusicListPage4Screen(TrapNationMusicListPage4Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("music_electronic:textures/screens/trap_nation_music_list_page_4.png");
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 9, this.topPos + 42, 46, 20, Component.literal("Play"), e -> {
			if (true) {
				MusicElectronicMod.PACKET_HANDLER.sendToServer(new TrapNationMusicListPage4ButtonMessage(0, x, y, z));
				TrapNationMusicListPage4ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}));
		this.addRenderableWidget(new Button(this.leftPos + 117, this.topPos + 6, 77, 20, Component.literal("Stop Music"), e -> {
			if (true) {
				MusicElectronicMod.PACKET_HANDLER.sendToServer(new TrapNationMusicListPage4ButtonMessage(1, x, y, z));
				TrapNationMusicListPage4ButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		}));
		this.addRenderableWidget(new Button(this.leftPos + 207, this.topPos + 6, 30, 20, Component.literal("x"), e -> {
			if (true) {
				MusicElectronicMod.PACKET_HANDLER.sendToServer(new TrapNationMusicListPage4ButtonMessage(2, x, y, z));
				TrapNationMusicListPage4ButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		}));
		...
		this.addRenderableWidget(new Button(this.leftPos + 99, this.topPos + 168, 56, 20, Component.literal("Credit"), e -> {
			if (true) {
				MusicElectronicMod.PACKET_HANDLER.sendToServer(new TrapNationMusicListPage4ButtonMessage(4, x, y, z));
				TrapNationMusicListPage4ButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		}));
		...
		this.addRenderableWidget(new Button(this.leftPos + 162, this.topPos + 168, 30, 20, Component.literal(">"), e -> {
			if (true) {
				MusicElectronicMod.PACKET_HANDLER.sendToServer(new TrapNationMusicListPage4ButtonMessage(7, x, y, z));
				TrapNationMusicListPage4ButtonMessage.handleButtonAction(entity, 7, x, y, z);
			}
		}));
		this.addRenderableWidget(new Button(this.leftPos + 63, this.topPos + 168, 30, 20, Component.literal("<"), e -> {
			if (true) {
				MusicElectronicMod.PACKET_HANDLER.sendToServer(new TrapNationMusicListPage4ButtonMessage(8, x, y, z));
				TrapNationMusicListPage4ButtonMessage.handleButtonAction(entity, 8, x, y, z);
			}
		}));
	}
}
