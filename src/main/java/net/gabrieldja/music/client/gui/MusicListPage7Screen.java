...
import net.gabrieldja.music.network.MusicListPage7ButtonMessage;
...
public class MusicListPage7Screen extends AbstractContainerScreen<MusicListPage7Menu> {
	private final static HashMap<String, Object> guistate = MusicListPage7Menu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public MusicListPage7Screen(MusicListPage7Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("music_electronic:textures/screens/music_list_page_7.png");
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 9, this.topPos + 42, 46, 20, new TextComponent("Play"), e -> {
			if (true) {
				MusicElectronicMod.PACKET_HANDLER.sendToServer(new MusicListPage7ButtonMessage(0, x, y, z));
				MusicListPage7ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}));
		this.addRenderableWidget(new Button(this.leftPos + 117, this.topPos + 6, 77, 20, new TextComponent("Stop Music"), e -> {
			if (true) {
				MusicElectronicMod.PACKET_HANDLER.sendToServer(new MusicListPage7ButtonMessage(1, x, y, z));
				MusicListPage7ButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		}));
		this.addRenderableWidget(new Button(this.leftPos + 207, this.topPos + 6, 30, 20, new TextComponent("x"), e -> {
			if (true) {
				MusicElectronicMod.PACKET_HANDLER.sendToServer(new MusicListPage7ButtonMessage(2, x, y, z));
				MusicListPage7ButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		}));
		...
		this.addRenderableWidget(new Button(this.leftPos + 99, this.topPos + 168, 56, 20, new TextComponent("Credit"), e -> {
			if (true) {
				MusicElectronicMod.PACKET_HANDLER.sendToServer(new MusicListPage7ButtonMessage(4, x, y, z));
				MusicListPage7ButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		}));
		...
		this.addRenderableWidget(new Button(this.leftPos + 162, this.topPos + 168, 30, 20, new TextComponent(">"), e -> {
			if (true) {
				MusicElectronicMod.PACKET_HANDLER.sendToServer(new MusicListPage7ButtonMessage(7, x, y, z));
				MusicListPage7ButtonMessage.handleButtonAction(entity, 7, x, y, z);
			}
		}));
		this.addRenderableWidget(new Button(this.leftPos + 63, this.topPos + 168, 30, 20, new TextComponent("<"), e -> {
			if (true) {
				MusicElectronicMod.PACKET_HANDLER.sendToServer(new MusicListPage7ButtonMessage(8, x, y, z));
				MusicListPage7ButtonMessage.handleButtonAction(entity, 8, x, y, z);
			}
		}));
	}
}
