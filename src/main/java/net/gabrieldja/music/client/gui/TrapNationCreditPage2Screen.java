...
import net.gabrieldja.music.network.TrapNationCreditPage2ButtonMessage;
...
public class TrapNationCreditPage2Screen extends AbstractContainerScreen<TrapNationCreditPage2Menu> {
	private final static HashMap<String, Object> guistate = TrapNationCreditPage2Menu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public TrapNationCreditPage2Screen(TrapNationCreditPage2Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("music_electronic:textures/screens/trap_nation_credit_page_2.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, "Spam : Juche", 14, 108, -16777216);
		this.font.draw(poseStack, "I Feel It : Kaivon", 14, 126, -16777216);
	}
