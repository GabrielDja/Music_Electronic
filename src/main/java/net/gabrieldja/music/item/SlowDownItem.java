...
public class SlowDownItem extends RecordItem {
	public SlowDownItem() {
		super(0, MusicElectronicModSounds.REGISTRY.get(new ResourceLocation("music_electronic:slow-down_shiah-maisel_jim-yosef")),
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Time - 02:29"));
	}
}
