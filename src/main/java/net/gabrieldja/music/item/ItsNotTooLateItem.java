...
public class ItsNotTooLateItem extends RecordItem {
	public ItsNotTooLateItem() {
		super(0, MusicElectronicModSounds.REGISTRY.get(new ResourceLocation("music_electronic:its-not-too-late_kaivon")),
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Time - 04:34"));
	}
}
