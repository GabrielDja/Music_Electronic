...
public class NewsToMeItem extends RecordItem {
	public NewsToMeItem() {
		super(0, MusicElectronicModSounds.REGISTRY.get(new ResourceLocation("music_electronic:news-to-me_too-martian_shiah-maisel_nct")),
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Time - 03:33"));
	}
}
