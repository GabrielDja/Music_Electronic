...
public class FeelingItem extends RecordItem {
	public FeelingItem() {
		super(0, MusicElectronicModSounds.REGISTRY.get(new ResourceLocation("music_electronic:feeling_cajama-and-tisoki")),
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Time - 02:41"));
	}
}
