...
public class IFeelItItem extends RecordItem {
	public IFeelItItem() {
		super(0, () -> ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("music_electronic:kaivon_i-feel-it")),
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("Time - 02:46"));
	}
}
