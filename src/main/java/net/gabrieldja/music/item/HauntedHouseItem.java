...
public class HauntedHouseItem extends RecordItem {
	public HauntedHouseItem() {
		super(0, MusicElectronicModSounds.REGISTRY.get(new ResourceLocation("music_electronic:haunted-hause_noeni")),
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Time - 03:01"));
	}
}
