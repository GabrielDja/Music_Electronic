...
public class LiveALieItem extends RecordItem {
	public LiveALieItem() {
		super(0, MusicElectronicModSounds.REGISTRY.get(new ResourceLocation("music_electronic:live-a-lie_andreas-stone_egzod-rival")),
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Time - 03:32"));
	}
}
