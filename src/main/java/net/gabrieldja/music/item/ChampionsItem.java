...
public class ChampionsItem extends RecordItem {
	public ChampionsItem() {
		super(0, MusicElectronicModSounds.REGISTRY.get(new ResourceLocation("music_electronic:champions_donna--tella_lunaar_elektronomia")),
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Time - 03:30"));
	}
}
