...
public class YesterdayItem extends RecordItem {
	public YesterdayItem() {
		super(0, MusicElectronicModSounds.REGISTRY.get(new ResourceLocation("music_electronic:yesterday_4ura_young-viridii")),
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Time - 03:26"));
	}
}
