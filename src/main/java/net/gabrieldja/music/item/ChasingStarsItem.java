...
public class ChasingStarsItem extends RecordItem {
	public ChasingStarsItem() {
		super(0, MusicElectronicModSounds.REGISTRY.get(new ResourceLocation("music_electronic:chasing-stars_star-seed")),
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Time - 03:05"));
	}
}
