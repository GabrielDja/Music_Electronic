...
public class VisionPtIIItem extends RecordItem {
	public VisionPtIIItem() {
		super(0, MusicElectronicModSounds.REGISTRY.get(new ResourceLocation("music_electronic:vision-pt-ii_she-is-jules_lost-sky")),
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Time - 03:28"));
	}
}
