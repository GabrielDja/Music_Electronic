...
public class FireItem extends RecordItem {
	public FireItem() {
		super(0, MusicElectronicModSounds.REGISTRY.get(new ResourceLocation("music_electronic:fire_brook-xiao_rachel-horter")),
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Time - 02:53"));
	}
}
