...
public class SurviveItem extends RecordItem {
	public SurviveItem() {
		super(0, MusicElectronicModSounds.REGISTRY.get(new ResourceLocation("music_electronic:survive_axel-oliver_theboywithspec")),
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Time - 04:09"));
	}
}
