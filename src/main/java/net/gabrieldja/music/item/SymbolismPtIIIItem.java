...
public class SymbolismPtIIIItem extends RecordItem {
	public SymbolismPtIIIItem() {
		super(0, MusicElectronicModSounds.REGISTRY.get(new ResourceLocation("music_electronic:symbolism-pt-iii_electro-light")),
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Time - 04:07"));
	}
}
