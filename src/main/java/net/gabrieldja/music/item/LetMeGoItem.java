...
public class LetMeGoItem extends RecordItem {
	public LetMeGoItem() {
		super(0, MusicElectronicModSounds.REGISTRY.get(new ResourceLocation("music_electronic:let-me-go_jimmy-rivler_max-vermeulen_almost-weekend")),
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Time - 02:40"));
	}
}
