...
public class ArcSecondItem extends RecordItem {
	public ArcSecondItem() {
		super(0, MusicElectronicModSounds.REGISTRY.get(new ResourceLocation("music_electronic:arc-second_slumberjack_tinykvt")),
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Time - 03:36"));
	}
}
