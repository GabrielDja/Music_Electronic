...
public class WhereItAllBeganItem extends RecordItem {
	public WhereItAllBeganItem() {
		super(0, MusicElectronicModSounds.REGISTRY.get(new ResourceLocation("music_electronic:where-it-all-began_danyka-nadeau_electro-light")),
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Time - 03:51"));
	}
}
