...
public class BotFightItem extends RecordItem {
	public BotFightItem() {
		super(0, MusicElectronicModSounds.REGISTRY.get(new ResourceLocation("music_electronic:bot-fight_everen-maxwell")),
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Time - 04:35"));
	}
}
