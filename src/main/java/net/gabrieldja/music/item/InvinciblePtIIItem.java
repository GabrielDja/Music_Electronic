...
public class InvinciblePtIIItem extends RecordItem {
	public InvinciblePtIIItem() {
		super(0, () -> ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("music_electronic:invincible-pt-ii_sendi-hoxha_deaf-kev")),
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("Time - 03:15"));
	}
}
